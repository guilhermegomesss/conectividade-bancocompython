...
# Classe Aluno
class Aluno:
    def __init__(self, nome, data_nascimento, turma_id,cpf):
        self.nome = nome
    ...
    def salvar(self):
        query = "INSERT INTO Alunos (Nome, DataNascimento, TurmaID, CPF) VALUES (%s, %s, %s, %s)"
...
class Disciplina:
    def __init__(self, nome_disciplina, turma_id,cpf):
        self.nome_disciplina = nome_disciplina
        self.turma_id = turma_id
        self.cpf = cpf

    def salvar(self):
        query = "INSERT INTO Disciplinas (NomeDisciplina,TurmaID,CPF) VALUES (%s, %s,%s)"
        values = (self.nome_disciplina,turma_id,cpf)
        cursor.execute(query, values)
        db.commit()
